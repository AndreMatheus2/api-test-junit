package br.com.andrematheus2.api.services.impl;
...
class UserServiceImplTest {
    ...
    public static final String EMAIL    = "am_arao@hotmail.com";
    ...
    @Test
    void whendfindAllThenReturnAnListOfUser() {
    ...
    @Test
    void whenCreatedThenReturnReturnSuccess() {
    ...
    @Test
    void whenUpDateThenReturnReturnSuccess() {
        when(repository.save(any())).thenReturn(user);
    ...
    private void startUser() {
        ...
        userDTO = new UserDTO(ID, EMAIL, EMAIL, PASSWORD );
        optionalUser = Optional.of(new User(ID, EMAIL, EMAIL, PASSWORD));
    }
}